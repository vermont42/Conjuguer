...
class ConjuguerTests: XCTestCase {
  func testCompoundTenses() {
    ...
    for conjugation in ["Étais allé", "Étais allé", "Était allé", "Étions allé", "Étiez allé", "Étaient allé"] {
      T.testConjugation(infinitif: aller, tense: .plusQueParfait(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }
    ...
    for conjugation in ["Eus EU", "Eus EU", "Eut EU", "Eûmes EU", "Eûtes EU", "Eurent EU"] {
      T.testConjugation(infinitif: avoir, tense: .passéAntérieur(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }
    ...
    for conjugation in ["SErai allé", "SEras allé", "SEra allé", "SErons allé", "SErez allé", "SEront allé"] {
      T.testConjugation(infinitif: aller, tense: .futurAntérieur(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["aUrai EU", "aUras EU", "aUra EU", "aUrons EU", "aUrez EU", "aUront EU"] {
      T.testConjugation(infinitif: avoir, tense: .futurAntérieur(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["SErais allé", "SErais allé", "SErait allé", "SErions allé", "SEriez allé", "SEraient allé"] {
      T.testConjugation(infinitif: aller, tense: .conditionnelPassé(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["aUrais EU", "aUrais EU", "aUrait EU", "aUrions EU", "aUriez EU", "aUraient EU"] {
      T.testConjugation(infinitif: avoir, tense: .conditionnelPassé(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }
    ...
    for conjugation in ["Eusse EU", "Eusses EU", "Eût EU", "Eussions EU", "Eussiez EU", "Eussent EU"] {
      T.testConjugation(infinitif: avoir, tense: .subjonctifPlusQueParfait(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }
    ...
    for conjugation in ["SOIs allé", "SOYons allé", "SOYez allé"] {
      T.testConjugation(infinitif: aller, tense: .impératifPassé(PersonNumber.impératifPersonNumbers[impératifPersonNumbersIndex]), expected: conjugation)
