...
class VerbModelTests: XCTestCase {
  ...
  func testAcquérir() {
    ...
    for conjugation in ["acquIErs", "acquIErs", "acquIErt", "acquérons", "acquérez", "acquIÈrent"] {
      T.testConjugation(infinitif: "acquérir", tense: .indicatifPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["acquérais", "acquérais", "acquérait", "acquérions", "acquériez", "acquéraient"] {
      T.testConjugation(infinitif: "acquérir", tense: .imparfait(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["acquERrai", "acquERras", "acquERra", "acquERrons", "acquERrez", "acquERront"] {
      T.testConjugation(infinitif: "acquérir", tense: .futurSimple(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["acquERrais", "acquERrais", "acquERrait", "acquERrions", "acquERriez", "acquERraient"] {
      T.testConjugation(infinitif: "acquérir", tense: .conditionnelPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["acqUis", "acqUis", "acqUit", "acqUîmes", "acqUîtes", "acqUirent"] {
      T.testConjugation(infinitif: "acquérir", tense: .passéSimple(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["acquIÈre", "acquIÈres", "acquIÈre", "acquérions", "acquériez", "acquIÈrent"] {
      T.testConjugation(infinitif: "acquérir", tense: .subjonctifPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["acqUisse", "acqUisses", "acqUît", "acqUissions", "acqUissiez", "acqUissent"] {
      T.testConjugation(infinitif: "acquérir", tense: .subjonctifImparfait(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    T.testConjugation(infinitif: "acquérir", tense: .participePassé, expected: "acqUiS")
    T.testConjugation(infinitif: "acquérir", tense: .participePrésent, expected: "acquérant")

    var impératifPersonNumbersIndex = 0

    for conjugation in ["acquIErs", "acquérons", "acquérez"] {
      T.testConjugation(infinitif: "acquérir", tense: .impératif(PersonNumber.impératifPersonNumbers[impératifPersonNumbersIndex]), expected: conjugation)
      impératifPersonNumbersIndex += 1
      impératifPersonNumbersIndex %= PersonNumber.impératifPersonNumbers.count
    }
  }
  ...
  func testApparoir() {
    ...
    for conjugation in ["apparOIs", "apparOIs", "appErt", "apparOYons", "apparOYez", "apparOIent"] {
      T.testConjugation(infinitif: "apparoir", tense: .indicatifPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["apparOYais", "apparOYais", "apparOYait", "apparOYions", "apparOYiez", "apparOYaient"] {
      T.testConjugation(infinitif: "apparoir", tense: .imparfait(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["apparoirai", "apparoiras", "apparoira", "apparoirons", "apparoirez", "apparoiront"] {
      T.testConjugation(infinitif: "apparoir", tense: .futurSimple(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["apparoirais", "apparoirais", "apparoirait", "apparoirions", "apparoiriez", "apparoiraient"] {
      T.testConjugation(infinitif: "apparoir", tense: .conditionnelPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["apparis", "apparis", "apparit", "apparîmes", "apparîtes", "apparirent"] {
      T.testConjugation(infinitif: "apparoir", tense: .passéSimple(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["apparOIE", "apparOIES", "apparOIE", "apparOYIONS", "apparOYIEZ", "apparOIENT"] {
      T.testConjugation(infinitif: "apparoir", tense: .subjonctifPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["apparisse", "apparisses", "apparît", "apparissions", "apparissiez", "apparissent"] {
      T.testConjugation(infinitif: "apparoir", tense: .subjonctifImparfait(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    T.testConjugation(infinitif: "apparoir", tense: .participePassé, expected: "apparU")
    T.testConjugation(infinitif: "apparoir", tense: .participePrésent, expected: "apparOYant")

    var impératifPersonNumbersIndex = 0

    for conjugation in ["apparOIs", "apparOYons", "apparOYez"] {
      T.testConjugation(infinitif: "apparoir", tense: .impératif(PersonNumber.impératifPersonNumbers[impératifPersonNumbersIndex]), expected: conjugation)
      impératifPersonNumbersIndex += 1
      impératifPersonNumbersIndex %= PersonNumber.impératifPersonNumbers.count
    }
  }
  ...
  func testClore() {
    ...
    for conjugation in ["clos", "clos", "clÔt", "cloSons", "cloSez", "cloSent"] {
      T.testConjugation(infinitif: "clore", tense: .indicatifPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["cloSais", "cloSais", "cloSait", "cloSions", "cloSiez", "cloSaient"] {
      T.testConjugation(infinitif: "clore", tense: .imparfait(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["clorai", "cloras", "clora", "clorons", "clorez", "cloront"] {
      T.testConjugation(infinitif: "clore", tense: .futurSimple(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["clorais", "clorais", "clorait", "clorions", "cloriez", "cloraient"] {
      T.testConjugation(infinitif: "clore", tense: .conditionnelPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["clos", "clos", "clot", "clômes", "clôtes", "clorent"] {
      T.testConjugation(infinitif: "clore", tense: .passéSimple(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["cloSe", "cloSes", "cloSe", "cloSions", "cloSiez", "cloSent"] {
      T.testConjugation(infinitif: "clore", tense: .subjonctifPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["closse", "closses", "clôt", "clossions", "clossiez", "clossent"] {
      T.testConjugation(infinitif: "clore", tense: .subjonctifImparfait(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    T.testConjugation(infinitif: "clore", tense: .participePassé, expected: "cloS")
    T.testConjugation(infinitif: "clore", tense: .participePrésent, expected: "cloSant")

    var impératifPersonNumbersIndex = 0

    for conjugation in ["clos", "cloSons", "cloSez"] {
      T.testConjugation(infinitif: "clore", tense: .impératif(PersonNumber.impératifPersonNumbers[impératifPersonNumbersIndex]), expected: conjugation)
      impératifPersonNumbersIndex += 1
      impératifPersonNumbersIndex %= PersonNumber.impératifPersonNumbers.count
    }
  }
  ...
  func testCourir() {
    ...
    for conjugation in ["cours", "cours", "court", "courons", "courez", "courent"] {
      T.testConjugation(infinitif: "courir", tense: .indicatifPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["courais", "courais", "courait", "courions", "couriez", "couraient"] {
      T.testConjugation(infinitif: "courir", tense: .imparfait(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["couRrai", "couRras", "couRra", "couRrons", "couRrez", "couRront"] {
      T.testConjugation(infinitif: "courir", tense: .futurSimple(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["couRrais", "couRrais", "couRrait", "couRrions", "couRriez", "couRraient"] {
      T.testConjugation(infinitif: "courir", tense: .conditionnelPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["courus", "courus", "courut", "courûmes", "courûtes", "coururent"] {
      T.testConjugation(infinitif: "courir", tense: .passéSimple(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["courE", "courES", "courE", "courIONS", "courIEZ", "courENT"] {
      T.testConjugation(infinitif: "courir", tense: .subjonctifPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["courusse", "courusses", "courût", "courussions", "courussiez", "courussent"] {
      T.testConjugation(infinitif: "courir", tense: .subjonctifImparfait(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    T.testConjugation(infinitif: "courir", tense: .participePassé, expected: "courU")
    T.testConjugation(infinitif: "courir", tense: .participePrésent, expected: "courant")

    var impératifPersonNumbersIndex = 0

    for conjugation in ["cours", "courons", "courez"] {
      T.testConjugation(infinitif: "courir", tense: .impératif(PersonNumber.impératifPersonNumbers[impératifPersonNumbersIndex]), expected: conjugation)
      impératifPersonNumbersIndex += 1
      impératifPersonNumbersIndex %= PersonNumber.impératifPersonNumbers.count
    }
  }
  ...
  func testForclore() {
    ...
    for conjugation in ["forclos", "forclos", "forclot", "forcloSons", "forcloSez", "forcloSent"] {
      T.testConjugation(infinitif: "forclore", tense: .indicatifPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["forcloSais", "forcloSais", "forcloSait", "forcloSions", "forcloSiez", "forcloSaient"] {
      T.testConjugation(infinitif: "forclore", tense: .imparfait(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["forclorai", "forcloras", "forclora", "forclorons", "forclorez", "forcloront"] {
      T.testConjugation(infinitif: "forclore", tense: .futurSimple(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["forclorais", "forclorais", "forclorait", "forclorions", "forcloriez", "forcloraient"] {
      T.testConjugation(infinitif: "forclore", tense: .conditionnelPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["forclos", "forclos", "forclot", "forclômes", "forclôtes", "forclorent"] {
      T.testConjugation(infinitif: "forclore", tense: .passéSimple(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["forcloSe", "forcloSes", "forcloSe", "forcloSions", "forcloSiez", "forcloSent"] {
      T.testConjugation(infinitif: "forclore", tense: .subjonctifPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["forclosse", "forclosses", "forclôt", "forclossions", "forclossiez", "forclossent"] {
      T.testConjugation(infinitif: "forclore", tense: .subjonctifImparfait(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    T.testConjugation(infinitif: "forclore", tense: .participePassé, expected: "forcloS")
    T.testConjugation(infinitif: "forclore", tense: .participePrésent, expected: "forcloSant")

    var impératifPersonNumbersIndex = 0

    for conjugation in ["forclos", "forcloSons", "forcloSez"] {
      T.testConjugation(infinitif: "forclore", tense: .impératif(PersonNumber.impératifPersonNumbers[impératifPersonNumbersIndex]), expected: conjugation)
      impératifPersonNumbersIndex += 1
      impératifPersonNumbersIndex %= PersonNumber.impératifPersonNumbers.count
    }
  }
  ...
  func testFoutre() {
    ...
    for conjugation in ["foUs", "foUs", "fout", "foutons", "foutez", "foutent"] {
      T.testConjugation(infinitif: "foutre", tense: .indicatifPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["foutais", "foutais", "foutait", "foutions", "foutiez", "foutaient"] {
      T.testConjugation(infinitif: "foutre", tense: .imparfait(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["foutrai", "foutras", "foutra", "foutrons", "foutrez", "foutront"] {
      T.testConjugation(infinitif: "foutre", tense: .futurSimple(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["foutrais", "foutrais", "foutrait", "foutrions", "foutriez", "foutraient"] {
      T.testConjugation(infinitif: "foutre", tense: .conditionnelPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["foutis", "foutis", "foutit", "foutîmes", "foutîtes", "foutirent"] {
      T.testConjugation(infinitif: "foutre", tense: .passéSimple(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["foute", "foutes", "foute", "foutions", "foutiez", "foutent"] {
      T.testConjugation(infinitif: "foutre", tense: .subjonctifPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["foutisse", "foutisses", "foutît", "foutissions", "foutissiez", "foutissent"] {
      T.testConjugation(infinitif: "foutre", tense: .subjonctifImparfait(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    T.testConjugation(infinitif: "foutre", tense: .participePassé, expected: "foutu")
    T.testConjugation(infinitif: "foutre", tense: .participePrésent, expected: "foutant")

    var impératifPersonNumbersIndex = 0

    for conjugation in ["foUs", "foutons", "foutez"] {
      T.testConjugation(infinitif: "foutre", tense: .impératif(PersonNumber.impératifPersonNumbers[impératifPersonNumbersIndex]), expected: conjugation)
      impératifPersonNumbersIndex += 1
      impératifPersonNumbersIndex %= PersonNumber.impératifPersonNumbers.count
    }
  }
  ...
  func testMourir() {
    ...
    for conjugation in ["mEurs", "mEurs", "mEurt", "mourons", "mourez", "mEurent"] {
      T.testConjugation(infinitif: "mourir", tense: .indicatifPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["mourais", "mourais", "mourait", "mourions", "mouriez", "mouraient"] {
      T.testConjugation(infinitif: "mourir", tense: .imparfait(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["mouRrai", "mouRras", "mouRra", "mouRrons", "mouRrez", "mouRront"] {
      T.testConjugation(infinitif: "mourir", tense: .futurSimple(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["mouRrais", "mouRrais", "mouRrait", "mouRrions", "mouRriez", "mouRraient"] {
      T.testConjugation(infinitif: "mourir", tense: .conditionnelPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["mourus", "mourus", "mourut", "mourûmes", "mourûtes", "moururent"] {
      T.testConjugation(infinitif: "mourir", tense: .passéSimple(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["mEurE", "mEurES", "mEurE", "mourIONS", "mourIEZ", "mEurENT"] {
      T.testConjugation(infinitif: "mourir", tense: .subjonctifPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["mourusse", "mourusses", "mourût", "mourussions", "mourussiez", "mourussent"] {
      T.testConjugation(infinitif: "mourir", tense: .subjonctifImparfait(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    T.testConjugation(infinitif: "mourir", tense: .participePassé, expected: "mOrT")
    T.testConjugation(infinitif: "mourir", tense: .participePrésent, expected: "mourant")

    var impératifPersonNumbersIndex = 0

    for conjugation in ["mEurs", "mourons", "mourez"] {
      T.testConjugation(infinitif: "mourir", tense: .impératif(PersonNumber.impératifPersonNumbers[impératifPersonNumbersIndex]), expected: conjugation)
      impératifPersonNumbersIndex += 1
      impératifPersonNumbersIndex %= PersonNumber.impératifPersonNumbers.count
    }
  }
  ...
  func testPartir() {
    ...
    for conjugation in ["paRs", "paRs", "paRt", "partons", "partez", "partent"] {
      T.testConjugation(infinitif: "partir", tense: .indicatifPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["partais", "partais", "partait", "partions", "partiez", "partaient"] {
      T.testConjugation(infinitif: "partir", tense: .imparfait(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["partirai", "partiras", "partira", "partirons", "partirez", "partiront"] {
      T.testConjugation(infinitif: "partir", tense: .futurSimple(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["partirais", "partirais", "partirait", "partirions", "partiriez", "partiraient"] {
      T.testConjugation(infinitif: "partir", tense: .conditionnelPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["partis", "partis", "partit", "partîmes", "partîtes", "partirent"] {
      T.testConjugation(infinitif: "partir", tense: .passéSimple(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["partE", "partES", "partE", "partIONS", "partIEZ", "partENT"] {
      T.testConjugation(infinitif: "partir", tense: .subjonctifPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["partisse", "partisses", "partît", "partissions", "partissiez", "partissent"] {
      T.testConjugation(infinitif: "partir", tense: .subjonctifImparfait(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    T.testConjugation(infinitif: "partir", tense: .participePassé, expected: "parti")
    T.testConjugation(infinitif: "partir", tense: .participePrésent, expected: "partant")

    var impératifPersonNumbersIndex = 0

    for conjugation in ["paRs", "partons", "partez"] {
      T.testConjugation(infinitif: "partir", tense: .impératif(PersonNumber.impératifPersonNumbers[impératifPersonNumbersIndex]), expected: conjugation)
      impératifPersonNumbersIndex += 1
      impératifPersonNumbersIndex %= PersonNumber.impératifPersonNumbers.count
    }
  }
  ...
  func testPlaire() {
    ...
    for conjugation in ["plais", "plais", "plaÎt", "plaiSons", "plaiSez", "plaiSent"] {
      T.testConjugation(infinitif: "plaire", tense: .indicatifPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["plaiSais", "plaiSais", "plaiSait", "plaiSions", "plaiSiez", "plaiSaient"] {
      T.testConjugation(infinitif: "plaire", tense: .imparfait(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["plairai", "plairas", "plaira", "plairons", "plairez", "plairont"] {
      T.testConjugation(infinitif: "plaire", tense: .futurSimple(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["plairais", "plairais", "plairait", "plairions", "plairiez", "plairaient"] {
      T.testConjugation(infinitif: "plaire", tense: .conditionnelPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["pLus", "pLus", "pLut", "pLûmes", "pLûtes", "pLurent"] {
      T.testConjugation(infinitif: "plaire", tense: .passéSimple(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["plaiSe", "plaiSes", "plaiSe", "plaiSions", "plaiSiez", "plaiSent"] {
      T.testConjugation(infinitif: "plaire", tense: .subjonctifPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["pLusse", "pLusses", "pLût", "pLussions", "pLussiez", "pLussent"] {
      T.testConjugation(infinitif: "plaire", tense: .subjonctifImparfait(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    T.testConjugation(infinitif: "plaire", tense: .participePassé, expected: "pLu")
    T.testConjugation(infinitif: "plaire", tense: .participePrésent, expected: "plaiSant")

    var impératifPersonNumbersIndex = 0

    for conjugation in ["plais", "plaiSons", "plaiSez"] {
      T.testConjugation(infinitif: "plaire", tense: .impératif(PersonNumber.impératifPersonNumbers[impératifPersonNumbersIndex]), expected: conjugation)
      impératifPersonNumbersIndex += 1
      impératifPersonNumbersIndex %= PersonNumber.impératifPersonNumbers.count
    }
  }
  ...
  func testTaire() {
    ...
    for conjugation in ["tais", "tais", "tait", "taiSons", "taiSez", "taiSent"] {
      T.testConjugation(infinitif: "taire", tense: .indicatifPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["taiSais", "taiSais", "taiSait", "taiSions", "taiSiez", "taiSaient"] {
      T.testConjugation(infinitif: "taire", tense: .imparfait(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["tairai", "tairas", "taira", "tairons", "tairez", "tairont"] {
      T.testConjugation(infinitif: "taire", tense: .futurSimple(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["tairais", "tairais", "tairait", "tairions", "tairiez", "tairaient"] {
      T.testConjugation(infinitif: "taire", tense: .conditionnelPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["Tus", "Tus", "Tut", "Tûmes", "Tûtes", "Turent"] {
      T.testConjugation(infinitif: "taire", tense: .passéSimple(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["taiSe", "taiSes", "taiSe", "taiSions", "taiSiez", "taiSent"] {
      T.testConjugation(infinitif: "taire", tense: .subjonctifPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["Tusse", "Tusses", "Tût", "Tussions", "Tussiez", "Tussent"] {
      T.testConjugation(infinitif: "taire", tense: .subjonctifImparfait(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    T.testConjugation(infinitif: "taire", tense: .participePassé, expected: "Tu")
    T.testConjugation(infinitif: "taire", tense: .participePrésent, expected: "taiSant")
  ...
  func testVenir() {
    ...
    for conjugation in ["vIens", "vIens", "vIent", "venons", "venez", "vIeNnent"] {
      T.testConjugation(infinitif: "venir", tense: .indicatifPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["venais", "venais", "venait", "venions", "veniez", "venaient"] {
      T.testConjugation(infinitif: "venir", tense: .imparfait(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["vIenDrai", "vIenDras", "vIenDra", "vIenDrons", "vIenDrez", "vIenDront"] {
      T.testConjugation(infinitif: "venir", tense: .futurSimple(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["vIenDrais", "vIenDrais", "vIenDrait", "vIenDrions", "vIenDriez", "vIenDraient"] {
      T.testConjugation(infinitif: "venir", tense: .conditionnelPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["vIns", "vIns", "vInt", "vÎnmes", "vÎntes", "vInrent"] {
      T.testConjugation(infinitif: "venir", tense: .passéSimple(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["vIeNnE", "vIeNnES", "vIeNnE", "venIONS", "venIEZ", "vIeNnENT"] {
      T.testConjugation(infinitif: "venir", tense: .subjonctifPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["vInsse", "vInsses", "vÎnt", "vInssions", "vInssiez", "vInssent"] {
      T.testConjugation(infinitif: "venir", tense: .subjonctifImparfait(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    T.testConjugation(infinitif: "venir", tense: .participePassé, expected: "venU")
    T.testConjugation(infinitif: "venir", tense: .participePrésent, expected: "venant")

    var impératifPersonNumbersIndex = 0

    for conjugation in ["vIens", "venons", "venez"] {
      T.testConjugation(infinitif: "venir", tense: .impératif(PersonNumber.impératifPersonNumbers[impératifPersonNumbersIndex]), expected: conjugation)
      impératifPersonNumbersIndex += 1
      impératifPersonNumbersIndex %= PersonNumber.impératifPersonNumbers.count
    }
  }
  ...
  func testVêtir() {
    ...
    for conjugation in ["vêts", "vêts", "vêt", "vêtons", "vêtez", "vêtent"] {
      T.testConjugation(infinitif: "vêtir", tense: .indicatifPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["vêtais", "vêtais", "vêtait", "vêtions", "vêtiez", "vêtaient"] {
      T.testConjugation(infinitif: "vêtir", tense: .imparfait(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["vêtirai", "vêtiras", "vêtira", "vêtirons", "vêtirez", "vêtiront"] {
      T.testConjugation(infinitif: "vêtir", tense: .futurSimple(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["vêtirais", "vêtirais", "vêtirait", "vêtirions", "vêtiriez", "vêtiraient"] {
      T.testConjugation(infinitif: "vêtir", tense: .conditionnelPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["vêtis", "vêtis", "vêtit", "vêtîmes", "vêtîtes", "vêtirent"] {
      T.testConjugation(infinitif: "vêtir", tense: .passéSimple(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["vêtE", "vêtES", "vêtE", "vêtIONS", "vêtIEZ", "vêtENT"] {
      T.testConjugation(infinitif: "vêtir", tense: .subjonctifPrésent(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    for conjugation in ["vêtisse", "vêtisses", "vêtît", "vêtissions", "vêtissiez", "vêtissent"] {
      T.testConjugation(infinitif: "vêtir", tense: .subjonctifImparfait(PersonNumber.allCases[personNumbersIndex]), expected: conjugation)
      personNumbersIndex += 1
      personNumbersIndex %= PersonNumber.allCases.count
    }

    T.testConjugation(infinitif: "vêtir", tense: .participePassé, expected: "vêtU")
    T.testConjugation(infinitif: "vêtir", tense: .participePrésent, expected: "vêtant")

    var impératifPersonNumbersIndex = 0

    for conjugation in ["vêts", "vêtons", "vêtez"] {
      T.testConjugation(infinitif: "vêtir", tense: .impératif(PersonNumber.impératifPersonNumbers[impératifPersonNumbersIndex]), expected: conjugation)
      impératifPersonNumbersIndex += 1
      impératifPersonNumbersIndex %= PersonNumber.impératifPersonNumbers.count
    }
  }
