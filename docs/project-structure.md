...
└── Models/
    ...
    ├── StemAlterationAuditTests.swift  # Audits every -er verb whose stem ends in é + consonant: the stem must open to è before a mute ending
...
├── review-instructions.md         # How Josh reviews the verb pass: defaults, the review page, merging decisions into approvals
...
├── verb-pass-report.md            # GENERATED by corpus/working/build_report.py: the Stage 3 verb-pass report
